...
Donate link: http://www.agenwebsite.com/products/woocommerce-pos-shipping
Tags: woocommerce, ecommerce, woothemes, shipping, commerce, store, shop, sell, online store, cart, checkout, shopping, indonesia, pos
...
Woocommerce POS Shipping mengintegrasikan ongkos pengiriman dengan total belanja konsumen Anda pada saat checkout. Dengan beragam fitur yang ditawarkan, plugin ini sungguh powerful dan menjadikan plugin ini wajib digunakan ke semua toko online yang menggunakan wordpress.

= WooCommerce POS Free Version =

* Ongkos kirim POS Kilat
* Data kota POS Jakarta ke Seluruh Indonesia

= WooCommerce POS Full Version =

* Ongkir kirim POS Kilat & POS Express
* Data kota POS dari basis kota pengiriman yang dipilih ke Seluruh Indonesia
* Checkout berdasarkan kode pos
* Biaya Tambahan ( untuk Packing dll )
* Fitur Kalkulasi Ongkir di Halaman Cart
* Gratis update dan Bantuan Support

= WooCommerce POS Exclusive Version =
...
* Biaya Tambahan ( untuk Packing dll )
* Fitur Kalkulasi Ongkir di Halaman Cart
* Tracking mengirimkan no resi langsung ke email pelanggan dari halaman order woocommerce. ( Lacak Pengiriman )
* Free Shipping. Pengaturan pengiriman gratis dengan pos shipping berdasarkan Minimum Biaya, Tanggal, Kota
* Gratis update dan Bantuan Support

[Upgrade ke full version](http://www.agenwebsite.com/products/woocommerce-pos-shipping "Upgrade Ke Full Version dari AgenWebsite") dan dapatkan beragam fitur tambahan, update yang menarik serta [support dan bantuan](http://www.agenwebsite.com/support "Support dan Bantuan dari AgenWebsite") jika terjadi permasalahan dalam penggunaannya.
...
2. Aktifkan Plugin
3. Halaman pengaturan plugin di WooCommerce > Settings > POS Shipping
4. Anda sudah bisa menggunakan plugin ini, serta dapat mengkonfigurasi plugin sesuai dengan keinginan Anda.
5. Have fun!

Kami menyediakan [dokumentasi](http://docs.agenwebsite.com/products/woocommerce-pos-shipping "Dokumentasi WooCommerce POS Shipping") untuk Anda apabila mengalami kesulitan dalam menginstall atau mengupdate plugin WooCommerce POS Shipping. Bila masih mengalami kesulitan kami bersedia membantu Anda melalui [Ticket Support](http://www.agenwebsite.com/ticket "Support Ticket AgenWebsite").
...
Untuk memperluas wawasan tentang Plugin WooCommerce POS Shipping, lihat [dokumentasi](http://docs.agenwebsite.com/products/woocommerce-pos-shipping)
...
= Bisakah WooCommerce POS Shipping bekerja pada website saya? =

WooCommerce POS Shipping support dengan wordpress dan woocommerce versi terbaru, kami akan selalu update untuk versi terbarunya

= Dimana saya bisa melaporkan bug atau error ketika saya menggunakan WooCommerce POS Shipping? =
...
= WooCommerce POS Shipping luar biasa, bagaimana saya berkontribusi? =
